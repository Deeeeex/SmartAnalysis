...
def draw_pic(file_name):
    ...
    milkproduction = pd.read_csv('draw/static/file_upload/'+file_name, sep=',', index_col=0)
    ...
    imd_list=[imd_1,imd_2,imd_3,imd_4,imd_5,imd_6,imd_7,imd_8,imd_9,imd_10,imd_11
                ,imd_11,imd_12,imd_13,imd_14,imd_15,imd_16,imd_17,imd_18,imd_19,
